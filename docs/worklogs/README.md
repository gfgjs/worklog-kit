...
- token税二轮-写侧纪律与护栏改口径 — 2026-07-19 — 承 F-021 首轮体积杠杆定位,二轮推进写侧纪律(完成即折叠/写指针不写复述/消费当场标记/heredoc 追加)+ doctor est-token 双轨护栏(行数兜底+单件4k+合计6k)+ complete 阶段折叠检测;scrollery 实仓冒烟坐实咬合,dogfooding 当场撞出并修复模板段序坑(F-027);F-025/026/027 入经验账,D-032 阈值 no-promotion 留档 — `2026-07-19-token税二轮-写侧纪律与护栏改口径/`
